  ...
  attributes: {
    ...
    Cordillera: Schema.Attribute.Enumeration<
      [
        ...
        'Alpes',
        'Apeninos',
        'Montes de la Sierra Madre',
        'Montes del C\u00E1ucaso',
        'Cordillera Transhimalaya',
        'Cordillera Kunlun',
        'Cordillera Karakoram',
        'Cordillera del Atlas',
        'Montes Escandinavos',
        'Montes Altai',
        'Montes Apalaches',
        'Montes Tian Shan',
        'Cordillera de los Sudetes',
        'Pirineos',
        'Montes de la Costa',
        ...
        'Monta\u00F1as de Bighorn',
        'Montes Ozark',
        'Monta\u00F1as de Allegheny',
        'Montes de la Sierra Madre del Sur',
        ...
        'Montes Apuseni',
        'Montes del Jura',
        'Montes de los C\u00E1rpatos Blancos',
        'Montes de Tatra',
        ...
        'Alborz',
        'Montes de Sayan',
        'Montes de Verkhoyansk',
        'Montes de las Kamchatka',
        'Montes Ghats Occidentales',
        'Montes Ghats Orientales',
        'Montes de Sijote-Alin',
        'Montes Pindos',
        'Montes Aravalli',
        'Hindu Kush',
        'Montes de las Fars',
        ...
        'Cordillera de Annam (Vietnam)',
        'Drakensberg',
        'Montes Ahaggar',
        'Montes del Tibesti',
        'Montes de Ruwenzori',
        'Monta\u00F1as del Atlas',
        'Monta\u00F1as del Atlas del Sahara',
        'Montes de la Meseta de Adamaoua',
        'Alpes Australianos',
        'Montes Azules',
        'Alpes del Sur (Nueva Zelanda)',
        'Montes de Fiordland (Nueva Zelanda)',
        'Montes de Pap\u00FAa Nueva Guinea',
        'Montes Maoke',
        'Montes Raukumura',
      ]
    > &
